...
#generating output for a 1st order system -> dimx = 1
def results1(yM, yT, yE, t, results_dir, awgn_std):
...
#generating output for a 2nd order system ->dimx = 2
def results2(yM, yT, dyT, yE, dyE, t, results_dir, awgn_std):
...
#generating output for a 3rd order system -> dimx = 3
def results3(yM, yT, dyT, ddyT, yE, dyE, ddyE, t, results_dir, awgn_std):
